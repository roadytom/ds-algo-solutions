...
class Solution_Leetcode {
  ...
  public TreeNode lowestCommonAncestor(TreeNode root, TreeNode p, TreeNode q) {
    ...
    stack.push(new Pair<>(root, Solution_Leetcode.BOTH_PENDING));
    ...
    while (!stack.isEmpty()) {
      ...
      if (parent_state != Solution_Leetcode.BOTH_DONE) {

        // If both child traversals are pending
        if (parent_state == Solution_Leetcode.BOTH_PENDING) {
        ...
        if (child_node != null) {
          stack.push(new Pair<>(child_node, Solution_Leetcode.BOTH_PENDING));
        }
      } else {

...
void solve() {
    ...
    cin >> n;
    n--;
    ll res1 = mod_mul(n + 1, 1);
    ll res2 = mod_mul(mod_mul(mod_mul(n, n + 1), 3), mod_inv(2));
    ll res3 = mod_mul(mod_mul(mod_mul(n, mod_add(n, 1)), mod_add(mod_mul(2, n), 1)), mod_inv(3));
    cout << mod_mul(2022, mod_add(mod_add(res1, res2), res3)) << endl;
}

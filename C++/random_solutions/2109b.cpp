...
ll solve_inv(ll min_row, ll max_row, ll min_col, ll max_col, ll monster_row, ll monster_col) {
...
void solve() {
    int n, m, a, b;
    cin >> n >> m >> a >> b;
    ll first = solve_inv(a, n, 1, m, a, b);
    ll second = solve_inv(1, a, 1, m, a, b);
    ll third = solve_inv(1, n, b, m, a, b);
    ll four = solve_inv(1, n, 1, b, a, b);
    vector<ll> options{first, second, third, four};
    print(*min_element(all(options)) + 1);
}

...
/**
    array with with length n
    for every integer k from 1..n
        choose any element -> move it to the end
        print sum of last k elements
        restore
    task: make the sum of last k, maximum
*/
void solve() {
    int n;
    cin >> n;

...
void solve() {
    string l, r;
    cin >> l >> r;
    int first_uncommon_idx = 0;
    while (first_uncommon_idx < len(l) and l[first_uncommon_idx] == r[first_uncommon_idx]) {
        first_uncommon_idx++;
    }
    if (first_uncommon_idx >= len(l) or r[first_uncommon_idx] - l[first_uncommon_idx] >= 2) {
        cout << 2 * first_uncommon_idx << endl;
    } else {
        int ans = 2 * first_uncommon_idx + 1;
        for (int i = first_uncommon_idx + 1; i < len(l); i++) {
            if (l[i] == '9' and r[i] == '0') {
                ans++;
            } else {
                break;

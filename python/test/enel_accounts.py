...
# Read Excel file
file_path = 'Enel Accounts Start_End Dates.xlsx'  # Replace with your Excel file path
...
df[account_start_date] = df[account_start_date].dt.strftime('%m/%d/%Y')
df[account_end_date] = df[account_end_date].dt.strftime('%m/%d/%Y')

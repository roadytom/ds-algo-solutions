...
def solve():
    ...
    for c in s:
        if c == '0':
            ...
            one_count += 1
    max_achiavable = one_count // 2 + zero_count // 2
    min_achiavable = (max(one_count, zero_count) - min(one_count, zero_count)) // 2

    if min_achiavable <= k <= max_achiavable and k % 2 == min_achiavable % 2:
        print("YES")
    else:
        print("NO")

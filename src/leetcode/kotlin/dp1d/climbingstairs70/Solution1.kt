package leetcode.kotlin.climbingstairs70
...
class Solution1 {
    ...
    private class Memoize2<in T, in Dummy, out R>(val f: (T, Dummy) -> R) : (T, Dummy) -> R {
    ...
    private fun <T, Dummy, R> ((T, Dummy) -> R).memoize(): (T, Dummy) -> R = Memoize2(this)
}
